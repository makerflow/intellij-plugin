...
data class MarkDone200ResponseTodo (

    @field:JsonProperty("group")
    val group: kotlin.String? = null,

    @field:JsonProperty("type")
    val type: MarkDone200ResponseTodo.Type? = null,

    @field:JsonProperty("sourceType")
    val sourceType: MarkDone200ResponseTodo.SourceType? = null,
    ...
    val step: MarkDone200ResponseTodo.Step? = null
